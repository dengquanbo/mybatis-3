...
public class Configuration {
     ...
     * KeyGenerator 的映射
     * <p>
     * KEY：在 {@link #mappedStatements} 的 KEY 的基础上，跟上
    ...
    /**
     * 解析失败的{@code <select />、<insert />、<update />、<delete /> }节点集合
     */
    protected final Collection<XMLStatementBuilder> incompleteStatements = new LinkedList<>();

    /**
     * 未处理完成的 CacheRefResolver 集合，{@link org.apache.ibatis.builder.annotation.MapperAnnotationBuilder#parseCacheRef}，
     * <p>
     * 因为此处指向的 Cache 对象可能未初始化，后续处理
     */
    ...
    public Configuration() {
        ...
        // 注册到 languageRegistry 中，用于处理动态 sql
    ...
    /**
     * @param namespace           <mapper namespace/>定义的namespace
     * @param referencedNamespace <cache-ref namespace=/> 定义的namespace
     */
