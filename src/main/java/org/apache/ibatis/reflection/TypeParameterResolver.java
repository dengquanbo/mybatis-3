...
public class TypeParameterResolver {
     ...
     * 解析属性类型
     *
     * @return The field type as {@link Type}. If it has type parameters in the declaration,<br> they will be resolved
     * to the actual runtime {@link Type}s.
     */
     ...
     * 解析方法返回类型
     *
     * @return The return type of the method as {@link Type}. If it has type parameters in the declaration,<br> they
     ...
     * declaration,<br> they will be resolved to the actual runtime {@link Type}s.
     */
    ...
    private static ParameterizedType resolveParameterizedType(ParameterizedType parameterizedType, Type srcType,
                                                              Class<?> declaringClass) {
        // 实际类型，比如 Map<T,K> 实际类型为：class java.util.HashMap
        Class<?> rawType = (Class<?>) parameterizedType.getRawType();

        // 获得<> 里面的类型，可能多个，如上面为 T 和 K
