...
public class ForEachSqlNode implements SqlNode {
    ...
    /**
     * @param configuration
     * @param contents             包含的子节点
     * @param collectionExpression collection 属性值
     * @param index                index
     * @param item                 item 属性值
     * @param open                 open 属性值
     * @param close                close 属性值
     * @param separator            separator 属性值
     */
        ...
        public void appendSql(String sql) {
            GenericTokenParser parser = new GenericTokenParser("#{", "}", content -> {
                ...
                if (itemIndex != null && newContent.equals(content)) {
                    newContent = content.replaceFirst("^\\s*" + itemIndex + "(?![^.,:\\s])", itemizeItem(itemIndex,
                            index));
                }
                return "#{" + newContent + "}";
            });
