...
public class XMLMapperBuilder extends BaseBuilder {
	...
	private void cacheElement(XNode context) throws Exception {
		if (context != null) {
			...
			// TypeAliasRegistry 类自身注入基本类，Connection类又注入了数据库相关的类
	 ...
	 *
	 * <pre>
	 *     <resultMap id="NewsListMap" type=
	"cn.cover.server.news.domain.News" extends="" autoMapping="">
	 ...
	 *
	 *     <constructor >
	 *             <arg jdbcType="" javaType="" typeHandler="" column="" resultMap= select=""></arg>
	 *             <idArg jdbcType="" javaType="" typeHandler="" column="" resultMap= select=""></idArg>
	 *      </constructor>
	 *
	 * </pre>
	 *
	...
	private ResultMapping buildResultMappingFromContext(XNode context, Class<?> resultType, List<ResultFlag> flags)
		...
		// 这里会解析 <association> <collectin> <case> 内嵌的resultMap熟悉
	 ...
	 *
	 * 如果Collection的resultMap，resultType都为空，那么enclosingType 中必须有property属性配置的setXXX
	 * 方法，否则抛出 BuilderException
	 *
	 */
