...
public class PropertyParser {
    ...
    private static class VariableTokenHandler implements TokenHandler {
        ...
        /**
         * 这里实际是从 variables 中获取，所以我们需要关注的是传入时的 variables
         */
        ...
        /**
         *  该方法用于，查找 variables 中的属性值
         *
         *  在 GenericTokenParser 解析 ${username:dqb} 后，传入 username:dqb 来获取最终的属性值
         */
        @Override
        public String handleToken(String content) {
            if (variables != null) {
                ...
                if (enableDefaultValue) {
                    ...
                    // 这个 if 说明含有默认值 username:dqb，分别截取接口
                    if (separatorIndex >= 0) {
