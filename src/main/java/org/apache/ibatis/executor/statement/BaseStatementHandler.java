...
public abstract class BaseStatementHandler implements StatementHandler {
     ...
     *
     * @param executor        执行器
     * @param mappedStatement sql
     * @param parameterObject 参数
     * @param rowBounds
     * @param resultHandler
     * @param boundSql        这里可能为为空，例如：insert、update 、delete{@link org.apache.ibatis.executor.SimpleExecutor#doUpdate}
     */
